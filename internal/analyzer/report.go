...
func (rd *ReportData) RenderMarkdown() string {
	...
	rd.renderHeader(&b)
	rd.renderScoreBreakdown(&b)
	rd.renderDetectorResults(&b)
	rd.renderSecretScan(&b)
	rd.renderVulnScan(&b)
	rd.renderIssues(&b)
	rd.renderFooter(&b)
	return b.String()
...
func (rd *ReportData) renderHeader(b *strings.Builder) {
...
func (rd *ReportData) renderScoreBreakdown(b *strings.Builder) {
...
func (rd *ReportData) renderDetectorResults(b *strings.Builder) {
	b.WriteString("## Detector Results\n\n")
	b.WriteString("| Detector | Status |\n")
	b.WriteString("|----------|--------|\n")
...
func (rd *ReportData) renderSecretScan(b *strings.Builder) {
...
func (rd *ReportData) renderVulnScan(b *strings.Builder) {
...
func (rd *ReportData) renderIssues(b *strings.Builder) {
...
func (rd *ReportData) renderFooter(b *strings.Builder) {
	b.WriteString("---\n\n")
	b.WriteString("_Report generated by [ailinter](https://ailinter.dev) — Code Quality for AI-Assisted Development._\n")
}
...
// formatSeverityTitle capitalizes the first letter of a severity string.
func formatSeverityTitle(sev string) string {
	if sev == "" {
		return sev
	}
