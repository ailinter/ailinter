...
LDFLAGS := -ldflags "-s -w \
	-X github.com/ailinter/ailinter/internal/version.Version=$(VERSION) \
	-X github.com/ailinter/ailinter/internal/version.Commit=$(COMMIT) \
	-X github.com/ailinter/ailinter/internal/version.BuildDate=$(BUILD_DATE)"
